    ...
    <div className="text-white scrollbar-hidden">
      ...
      >
        ...
        <p className="border-l-12 border-blue-400 text-xl lg:w-[800px] pl-2 mt-8">
          Here are my projects that showcase my ability to build beautiful and
          functional websites, and reflect the effort I put into improving with
          every creation.
        </p>
      </motion.div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 auto-rows-[148px] md:auto-rows-[120px] md:gap-x-10 gap-y-8 md:gap-y-10 md:mt-20">
        ...
        {projects.map((project, index) => (
          <motion.div
            ...
            className={cn(
              "bg-white/15 rounded-lg border border-primary/40 row-span-2 md:row-span-3 overflow-hidden relative w-full cursor-pointer",
            )}
            initial={{
              opacity: 0,
              x: index % 2 === 0 ? 30 : -30,
          ...
          >
            ...
            />
            <div className="absolute inset-0 w-full bg-gradient-to-t from-black/45 to-black/10 transition-colors duration-300 hover:from-black/60 hover:to-black/20 ">
              <div className="absolute bottom-4 w-full px-4 py-2">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {project.technologyUsed.map((tech) => (
                    <Badge
                      variant={"secondary"}
                      className="py-1 px-4 rounded-full text"
                    >
                      {tech}
                    </Badge>
                  ))}
